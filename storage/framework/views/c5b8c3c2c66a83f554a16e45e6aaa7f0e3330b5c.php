...
<header class="main-header">
    ...
    <a href="<?php echo e(admin_url('/'), false); ?>" class="logo">
        ...
        <span class="logo-mini"><?php echo 'MobiSave'; ?></span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg"><?php echo 'MobiSave'; ?></span>
    </a>
                ...
                <li class="dropdown user user-menu">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-footer">
                            <div class="pull-left">
                                <a href="<?php echo e(admin_url('auth/setting'), false); ?>"
                                    class="btn btn-default btn-flat"><?php echo e(trans('admin.setting'), false); ?></a>
                            </div>
                            <div class="pull-right">
                                <a href="<?php echo e(admin_url('auth/logout'), false); ?>"
...
<?php /**PATH /Applications/MAMP/htdocs/marcci-dashboard/vendor/encore/laravel-admin/src/../resources/views/partials/header.blade.php ENDPATH**/ ?>