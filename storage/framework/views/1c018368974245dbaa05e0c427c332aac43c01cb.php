<div class="card  mb-4 mb-md-5 border-0" style="color: black;">
    ...
    <div class="card-body py-2 py-md-3">
        ...
        <a href="<?php echo e(admin_url('pests-and-diseases'), false); ?>" class="btn btn-primary btn-sm mt-3">View all gardens</a>
    </div>
</div>
    ...
    new Chart(document.getElementById('gardens-by-varieties').getContext('2d'), {
        ...
        data: {
            ...
            datasets: [{
                ...
                data: <?php echo e(json_encode($counts), false); ?>,
                backgroundColor: [
                    'rgba(0, 0, 255, 0.7)',
                    'rgba(255, 69, 0, 0.7)',
                    'rgba(255, 102, 0, 0.7)',
...
<?php /**PATH /Applications/MAMP/htdocs/marcci-dashboard/resources/views/widgets/by-categories.blade.php ENDPATH**/ ?>