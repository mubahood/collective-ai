...
<style>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <ul class="question-list">
                    ...
                    <li>
                        <h4><?php echo e($question->question, false); ?></h4>
                        <p class="answer-count">
                            <a href="<?php echo e(admin_url('question_answers', ['id' => $question->id]), false); ?>">
                                <?php echo e($question->answers->count(), false); ?> answers
                            </a>
                        </p>
                        <button type="button" class="btn btn-primary btn-answer" data-toggle="modal" data-target="#exampleModal" data-question-id="<?php echo e($question->id, false); ?>" data-question="<?php echo e($question->question, false); ?>">
                            Answer
                        </button>
                    </li>
    ...
    <script>
        ...
        $('#questionModal button[type="button"]').click(function (e) {
            ...
            $.ajax({
                url: "<?php echo e(route('store'), false); ?>",
                type: "POST",
                data: {
                    question: question,
                    user_id: user_id,
        ...
        $('#exampleModal .btn-submit').click(function (e) {
            ...
            $.ajax({
                url: "<?php echo e(route('answers'), false); ?>",
                type: "POST",
                data: {
                    answer: answer,
                    user_id: user_id,
...
<?php /**PATH /Applications/MAMP/htdocs/marcci-dashboard/resources/views/farmers-forum/chat.blade.php ENDPATH**/ ?>