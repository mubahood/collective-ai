...
<div class="card  mb-4 mb-md-5 border-0" style="color: black;">
    ...
    <div class="card-body py-2 py-md-3">
        ...
        <a href="<?php echo e(admin_url('pests-and-diseases'), false); ?>" class="btn btn-primary btn-sm mt-3">View all reports</a>
    </div>
</div>
...
<?php /**PATH /Applications/MAMP/htdocs/marcci-dashboard/resources/views/widgets/pests.blade.php ENDPATH**/ ?>