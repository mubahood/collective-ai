...
<body class="container">
    <h1>Privacy Policy for Marcci Mobile App</h1>

    <p>At https://marcci.8technologies.cloud, accessible from https://www.mak.ac.ug/marcci, one of our main priorities
        is the privacy of our visitors. This Privacy Policy document contains types of information that is collected and
        recorded by https://marcci.8technologies.cloud and how we use it.</p>
    ...
    <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website with regards
        to the information that they shared and/or collect in https://marcci.8technologies.cloud. This policy is not
    ...
    <p>https://marcci.8technologies.cloud follows a standard procedure of using log files. These files log visitors when
    ...
    <p>Like any other website, https://marcci.8technologies.cloud uses "cookies". These cookies are used to store
    ...
    <P>You may consult this list to find the Privacy Policy for each of the advertising partners of
        https://marcci.8technologies.cloud.</p>

    <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are used in
        their respective advertisements and links that appear on https://marcci.8technologies.cloud, which are sent
    ...
    <p>Note that https://marcci.8technologies.cloud has no access to or control over these cookies that are used by
        third-party advertisers.</p>

    <h2>Third Party Privacy Policies</h2>

    <p>https://marcci.8technologies.cloud's Privacy Policy does not apply to other advertisers or websites. Thus, we are
    ...
    <p>https://marcci.8technologies.cloud does not knowingly collect any Personal Identifiable Information from children
    ...
    <p>If you have any questions or suggestions about our Privacy Policy, contact us through email mubahood360@gmail.com
        .</p>
</body>

</html>
<?php /**PATH /Applications/MAMP/htdocs/marcci-dashboard/resources/views/policy.blade.php ENDPATH**/ ?>