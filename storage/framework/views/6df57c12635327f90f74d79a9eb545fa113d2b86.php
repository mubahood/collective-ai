...
<div class="card  mb-4 mb-md-5 border-0" style="color: black;">
    ...
    <div class="card-body py-2 py-md-3">
        ...
        <a href="<?php echo e(admin_url('gardens'), false); ?>" class="btn btn-primary btn-sm mt-3">View all gardens</a>
    </div>
</div>
...
<?php /**PATH /Applications/MAMP/htdocs/naro-dashboard/resources/views/widgets/by-categories.blade.php ENDPATH**/ ?>